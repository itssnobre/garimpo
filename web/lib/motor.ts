...
export function sinais(i: Imovel, t: T = (s) => s): Sinal[] {
  ...
  if (i.fonte === "caixa" && i.modalidade === "venda_direta") s.push({ nivel: "info", texto: t("Compra Direta da Caixa: sem leiloeiro, sem disputa e sem comissão de 5%, o primeiro que pagar o boleto leva. São 2 dias úteis para pagar, e o arrependimento vai até 7 dias corridos da homologação, com devolução integral (art. 49 do CDC). Depois disso vira desistência, com multa de 5% do valor da proposta e o resto devolvido sem correção. Regras da Venda Online, itens 12.1, 14.1 e 15.2.") });
