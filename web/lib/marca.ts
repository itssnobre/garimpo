...
export const PLANOS = [
  { nome: "Garimpo", preco: "Grátis", sub: "para quem quer só olhar", itens: ["Catálogo com todas as fontes de SP", "Score e margem líquida recalculada", "Régua de lance em cada lote", "Favoritos e filtros por região"], cta: "Ver os lotes", href: "/app/buscar", destaque: false },
