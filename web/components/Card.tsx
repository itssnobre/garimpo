    ...
    <article className="ficha">
      ...
      <div className="ficha-corpo">
        <div className="preco-linha">
          ...
          {!veto && (
            <div className="preco-tags">
              {i.valor_suspeito || i.desagio_pct >= 0.85 ? <span className="tag-desc suspeito" title="Deságio fora do normal: confira avaliação e lance na fonte antes de qualquer conta">valor a conferir</span> : <span className="tag-desc">-{pct(i.desagio_pct)}</span>}
        ...
        <ul className="fatos">
          ...
          {i.matricula ? <li title={`Matrícula ${i.matricula}`}><IDoc />matr. {matriculaCurta(i.matricula)}</li> : null}
        </ul>
        ...
        <div className="ficha-pe">
          <span>{MODALIDADE_LABEL[i.modalidade]}{i.praca ? ` · ${i.praca}ª praça` : ""} · {i.data_leilao ? dataBR(i.data_leilao) : "sem data"}</span>
