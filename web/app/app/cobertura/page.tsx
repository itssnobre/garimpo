...
export default function Cobertura() {
  ...
  return (<>
    <div className="app-cab"><div><h1>Cobertura</h1><p>Última coleta {new Date(META.gerado_em).toLocaleString("pt-BR")}. {IMOVEIS.length.toLocaleString("pt-BR")} lotes ativos em {cidades.size} cidades de SP.</p></div></div>
