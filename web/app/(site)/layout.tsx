      ...
      {children}
        <footer className="rodape">
          <div className="rodape-in">
            <div><img src="/marca/logo-light.svg" alt={MARCA} className="logo-img" style={{ marginBottom: 10 }} /><p className="mono" style={{ fontSize: 11.5 }}>{META.total.toLocaleString("pt-BR")} lotes · {Object.keys(META.fontes).length} fontes · coleta {gerado}</p></div>
